...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 19 2018 г., 18:03
...
('127.0.0.1', 0, 'http://stellar.rus/', 'http://stellar.rus/admin/index.php?route=marketplace/extension&amp;user_token=uwBxFpYxiR8cecDjAPNNTpPOmhJkaTAV&amp;type=module', '2018-10-19 14:59:28');
...
(31, 'Филин 120 PRO EDITION', '', '', '', '', '', '', '', 100000, 6, '', 0, 0, '6500.0000', 0, 0, '2018-10-01', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 1, 1, 3, '2018-10-01 15:57:48', '2018-10-01 15:57:48');
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=348;
