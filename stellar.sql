...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 17 2018 г., 13:44
...
('127.0.0.1', 0, 'http://stellar.rus/', 'http://localhost:3002/index.php?route=checkout/cart', '2018-09-17 10:40:03');
...
('1e8b4c0ab785a32fb824b47a07', '{\"user_id\":\"1\",\"user_token\":\"s0zAQLD6WOupgyE4upJJYAzgdlxQwrrg\",\"language\":\"ru-ru\",\"currency\":\"RUB\"}', '2018-09-17 10:19:45'),
...
('7f0649d90bf0cc2148e16f418d', '{\"language\":\"ru-ru\",\"currency\":\"RUB\"}', '2018-09-17 11:04:03'),
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
