...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 09 2018 г., 19:05
...
('127.0.0.1', 0, 'http://stellar.rus/index.php?route=common/home', 'http://localhost:3000/index.php?route=checkout/cart', '2018-10-09 15:57:40');
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
--
