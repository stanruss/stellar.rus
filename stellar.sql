...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 23 2018 г., 22:23
...
(8, 0, 0, 'b678b75d734a43d47d10d74dd1', 31, 0, '[]', 1, '2018-10-23 21:35:33'),
(14, 0, 0, 'd1a5cdb56da755592bdc3c5e98', 30, 0, '[]', 1, '2018-10-23 22:21:53');
...
('127.0.0.1', 0, 'http://stellar.rus/index.php?route=checkout/checkout', 'http://localhost:3000/index.php?route=checkout/cart', '2018-10-23 19:22:02');
...
(140, 1, 'featured.28', 'content_bottom', 0),
(139, 1, 'html.36', 'content_top', 0);
...
(30, 'Product 3', '', '', '', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 0, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, 55, '2009-02-03 16:59:00', '2018-10-01 15:52:40'),
...
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=376;
