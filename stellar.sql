...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 22 2018 г., 07:32
...
('127.0.0.1', 0, 'http://stellar.rus/', 'http://stellar.rus/admin/index.php?route=common/dashboard&amp;user_token=9XN7ybzEudH0aUCMd0EOF7Zjarcw43bP', '2018-08-22 04:29:37');
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=213;
