...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 14 2018 г., 18:55
...
(12, 0, 0, '2e4bafa9773d2b6a8de4baecd0', 30, 0, '[]', 1, '2018-08-14 18:50:34');
...
('127.0.0.1', 0, 'http://stellar.rus/index.php?route=common/home', 'http://stellar.rus/index.php?route=checkout/cart', '2018-08-14 15:51:37');
...
('a35109baab0fc64201f25291c8', '{\"language\":\"ru-ru\",\"currency\":\"RUB\",\"user_id\":\"1\",\"user_token\":\"dKmhTx8lcAfBmCxuBrTnRgQOROKH4hA3\"}', '2018-08-14 16:15:37'),
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;
