...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 22 2018 г., 17:00
...
('127.0.0.1', 0, 'http://stellar.rus/index.php?route=checkout/cart', 'http://stellar.rus/', '2018-10-22 13:58:13');
...
('37c04aa2bcbb84b4b4b29cb099', '{\"language\":\"ru-ru\",\"currency\":\"RUB\",\"user_id\":\"1\",\"user_token\":\"UZydupVWTvlTxwygys4wMzfnMezhhHhL\"}', '2018-10-22 14:22:13'),
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=360;
