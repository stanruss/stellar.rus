...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 27 2018 г., 19:35
...
('127.0.0.1', 0, 'http://stellar.rus/', 'http://stellar.rus/admin/index.php?route=extension/module/html&amp;user_token=K5ScLKYefjG0wKvPTJDFcKbz5ZTNEosM&amp;module_id=38', '2018-10-27 16:32:49');
...
(149, 1, 'html.38', 'content_bottom', 1),
(148, 1, 'featured.28', 'content_bottom', 0),
(147, 1, 'html.36', 'content_top', 0);
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=444;
--
