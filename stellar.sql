...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 17 2018 г., 13:43
...
('127.0.0.1', 0, 'http://stellar.rus/', 'http://localhost:3000/', '2018-10-17 10:32:25');
...
(133, 1, 'html.36', 'content_bottom', 1),
(132, 1, 'featured.28', 'content_bottom', 0);
...
(36, 'Main-menu', 'html', '{\"name\":\"Main-menu\",\"module_description\":{\"1\":{\"title\":\"\",\"description\":\"&lt;section id=&quot;Services&quot;&gt;\\r\\n\\r\\n&lt;\\/section&gt;\"},\"2\":{\"title\":\"\",\"description\":\"\"}},\"status\":\"1\"}');
...
(30, 'Product 3', '', '', '', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 0, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 0, 1, 0, 1, 39, '2009-02-03 16:59:00', '2018-10-01 15:52:40'),
...
('30056bd6f1e9d712b14bb1e200', '{\"language\":\"ru-ru\",\"currency\":\"RUB\"}', '2018-10-17 10:56:25'),
...
(322, 0, 'default', 'common/home', '{{ header }}\n&lt;div id=&quot;common-home&quot; class=&quot;container&quot;&gt;\n  &lt;div class=&quot;row&quot;&gt;{{ column_left }}\n    {% if column_left and column_right %}\n    {% set class = \'col-sm-6\' %}\n    {% elseif column_left or column_right %}\n    {% set class = \'col-sm-9\' %}\n    {% else %}\n    {% set class = \'col-sm-12\' %}\n    {% endif %}\n    &lt;div id=&quot;content&quot; class=&quot;{{ class }}&quot;&gt;{{ content_top }}{{ content_bottom }}&lt;/div&gt;\n    {{ column_right }}&lt;/div&gt;\n&lt;/div&gt;\n{{ footer }}', '2018-10-15 11:49:22'),
...
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=337;
